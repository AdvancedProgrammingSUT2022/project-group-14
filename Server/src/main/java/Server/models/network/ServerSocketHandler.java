        ...
        switch (request.getQueryRequest()) {
            ...
            case BUY_TILE -> {
                QueryResponses queryResponse = CityController.buyTileAndAddItToCityTerritory(WorldController.getWorld().getCivilizationByName(WorldController.getWorld().getCurrentCivilizationName()),
                        new Gson().fromJson(request.getParams().get("city"), City.class),
                        Integer.parseInt(request.getParams().get("x")),
                        Integer.parseInt(request.getParams().get("y")));
            ...
            case UNLOCK_CITIZEN_FROM_TILE -> {
                QueryResponses queryResponse = CityController.unlockCitizenFromTile(WorldController.getSelectedCity(),
                        Integer.parseInt(request.getParams().get("id")));
                return new Response(queryResponse, new HashMap<>());
            }
            case LOCK_CITIZEN_TO_TILE -> {
                QueryResponses queryResponse = CityController.lockCitizenToTile(WorldController.getSelectedCity(),
                        Integer.parseInt(request.getParams().get("id")),
                        Integer.parseInt(request.getParams().get("x")),
                        Integer.parseInt(request.getParams().get("y")));
                return new Response(queryResponse, new HashMap<>());
