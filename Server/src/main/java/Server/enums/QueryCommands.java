...
public enum QueryCommands {
    //city panel page
    GET_SELECTED_CITY,
    GET_EMPLOYED_CITIZENS_DATA,
    GET_UNEMPLOYED_CITIZENS_DATA,
    CAN_PRODUCE_UNIT,
    ...
    BUY_TILE,
    GET_CURRENT_CIVILIZATION_NAME,//پایین تر گرفتن خود تمدن فعلی هست پس شاید این نیاز نباشه
    PRODUCE_UNIT,
    PRODUCE_BUILDING,
    ...
    COMBAT_UNIT_ATTACKS_TILE,//THIS ONE NEEDS INPUT BECAUSE IN WOLRD CONTROLLER NEXT TURN THIS FUNCTION IS CALLED AND IT USES DIFFRENT INPUTS
