...
//            ImageView roadImage = new ImageView(Objects.requireNonNull(Main.class.getResource("/images/resources/road.png")).toString());
...
//            ImageView railRoadImage = new ImageView(Objects.requireNonNull(Main.class.getResource("/images/resources/railRoad.png")).toString());
